...
show_all() {
    ...
    echo ""
    echo -e "${DIM}Total: 15 skills | 33 frameworks | 7 categories${RESET}"
...
show_tags() {
    ...
    echo ""
    echo "90-day-plan, acquisition, AI, algorithm, application, attention,"
    echo "automation, behavioral-psychology, behavioral-science, behavior-change,"
    echo "books, brand, budgeting, business, business-ideas, co-founders,"
    echo "compound-interest, conversion, copying-framework, copywriting, creators,"
    ...
    echo "strategy, testing, tiktok, tool, validation, value-creation, video,"
    echo "volume, wealth-building, zero-to-one, 20-hours"
}
