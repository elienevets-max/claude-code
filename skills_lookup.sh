...
show_tags() {
    ...
    echo "co-founders, commission, compound-interest, consistency, conversion,"
    echo "copying-framework, copywriting, creators, CTA, curriculum, dashboard,"
    echo "decision-making, DREAM-framework, ecommerce,"
