...
show_all() {
    ...
    echo ""
    echo -e "${DIM}Total: 36 skills | 185 frameworks | 7 categories${RESET}"
...
show_tags() {
    ...
    echo "cart-abandonment, categorization, clear-thinking, CLV, co-founders,"
    echo "code-review, cognitive-bias, comment-reply-loop, commission,"
    echo "compound-interest, consistency, consulting, content-creation,"
    ...
    echo "experimentation, extremistan, falsifiability, fat-tails, fees,"
    ...
    echo "king-of-sparklers, landing-pages, Las-Vegas, learning, lifetime-value,"
    echo "lindy-effect, linkedin, LLM, loss-aversion, low-budget, loyalty,"
    echo "marketing, marketplace, market-research, mastery, mediocristan,"
    ...
    echo "psychology, purpose, rationality, readability, redundancy, relationships,"
