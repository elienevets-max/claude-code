...
show_all() {
    ...
    echo ""
    echo -e "${DIM}Total: 32 skills | 133 frameworks | 7 categories${RESET}"
...
show_tags() {
    ...
    echo "identity, intellectual-honesty, investing, investors, iteration, learning, LLM, low-budget,"
    echo "marketing, market-research, mastery, moats, money-scripts, motivated-reasoning, nextjs,"
    ...
    echo "scaling, scout-mindset, security, side-hustle, skill-acquisition, social-media,"
    echo "software-engineering, solo-founder, spending-plan, startup, strategy,"
    echo "structured-data, sunk-cost, system-prompts, systems, team-culture, testing, tiktok, tiktok-shop, tool,"
    echo "tutorial, updating, validation, value-creation, video, volume, wealth-building,"
    echo "zero-to-one"
}
